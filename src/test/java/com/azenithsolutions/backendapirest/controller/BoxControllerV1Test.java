...
import com.azenithsolutions.backendapirest.v1.controller.Box.BoxControllerV1;
...
public class BoxControllerV1Test {

    @Mock
    private BoxService boxService;

    @InjectMocks
    private BoxControllerV1 boxControllerV1;
    ...
    void testGetBoxes_success() {
        ...
        ResponseEntity<ApiResponseDTO<?>> response = boxControllerV1.getBoxes(request);
