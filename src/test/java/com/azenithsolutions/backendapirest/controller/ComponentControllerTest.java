...
class ComponentControllerTest {
    ...
    @Test
    void testSaveComponent_ReturnsCreated() {
        // Arrange
        ...
        // Act
        ResponseEntity<ApiResponseDTO<?>> response = componentController.createComponent(dto, request);
    ...
    @Test
    void testSaveComponent_ThrowsException_ReturnsInternalServerError() {
        // Arrange
        ComponentRequestDTO dto = new ComponentRequestDTO();
        dto.setIdHardWareTech("HW123");
        dto.setCaixa(1L);
    ...
    void testUpdateComponent_ReturnsOk() {
        ...
        // Act
        ResponseEntity<ApiResponseDTO<?>> response = componentController.updateComponent(id, dto, request);
